# -*- coding: utf-8 -*-
"""
Created on Mon Dec 28 11:04:48 2020
...
def function7():
    ...
    return np.zeros(x.shape).astype('int64')#write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.repeat(arr, 3)
    ans=np.concatenate((ans, arr, arr,arr),axis=None)#write your code here 
...
def function13():
    ...
    con1= np.extract(arr>5,arr)
    ans = np.extract(con1<10,con1)#write your code here 
...
def function18():
    ...
    x = np.count_nonzero(students<np.max(piaic))# Write you code Here
    return x
